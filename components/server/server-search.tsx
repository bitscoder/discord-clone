...
import { CommandDialog,CommandGroup, CommandEmpty, CommandInput, CommandItem, CommandList} from "@/components/ui/command";
    ...
    return(
        <>
            ...
            className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition">
                ...
                <kbd
                className="pointer evente-none inline-flex 
